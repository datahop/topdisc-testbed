...
| `cloud` | the same processes across hosts provisioned by Terraform on AWS or kadeploy on Grid'5000 (`deploy/`) | `./testbed <scenario>` on the coordinator host, driving one hostagent per host |
