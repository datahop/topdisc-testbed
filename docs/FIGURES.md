...
| 2. Discovery | Per-topic search results, find counts, scheduled lookups, final coverage, search provenance, search progress (with a re-walk flag); `02`, `03_time_to_fraction`, `02b`, `08`, `09`, `05`, `oh_06` |
