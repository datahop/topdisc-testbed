...
SECTIONS = [
    ...
    },
    {
        ...
        "figures": [
            ...
            ("12_search_bucket", "figures.py", "Where searches query: share of TOPICQUERY requests per search-table bucket (0 = farthest from the topic) and, for adaptive searches, the median active bucket over search time."),
            ("02b_time_to_first_cdf", "figures.py", "CDF of time to the first result, per topic, net of the node's scheduled absences when the run wrote churn.json."),
            ...
            ("05_id_space_found_vs_missed", "figures.py", "Share of the other searchers that returned each registrant, across the ID space; registrants online for less than an ad lifetime are hollow."),
    ...
    },
    {
        ...
        "figures": [
            ...
            ("oh_11_topic_load", "figures_overhead.py", "Load distribution per topic: search requests (TOPICQUERY) received and TOPICNODES bytes sent per registrar, and registration and lookup traffic per member."),
        ],
